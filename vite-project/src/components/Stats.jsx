...
import { Users, Award, GraduationCap, BookOpen, Briefcase, Globe } from 'lucide-react'
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-center text-green-700 mb-2">{stat.value}</h3>
