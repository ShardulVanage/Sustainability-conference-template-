          ...
          <div className="bg-white rounded-lg border-2 border-green-600 shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-400 to-teal-600 text-white p-4 pb-3">
              <div className="flex justify-between items-start">
                <div>
                  <span className="inline-block px-2 py-1 text-base font-semibold bg-white text-green-700 rounded-full mb-2">
                    PASUC Endorsed!!
                  </span>
                  ...
                  {isExpanded && (
                    ...
                    >
                      <p className="text-sm text-gray-600">
                        ...
                        innovation, and industrial futures intersect. Gathering experts to speak on innovative research
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          Paper submissions due: <span className="font-medium">March 7, 2025</span>
                        </span>
                      </div>
