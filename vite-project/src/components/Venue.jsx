...
export default function VenueSection() {
  ...
  return (
    <section ref={sectionRef} className="relative h-[800px] overflow-hidden bg-green-900 text-white">
      <motion.div
        ref={imageRef}
      ...
      <div className="relative z-20 container mx-auto px-4 py-24 flex flex-col justify-center items-center min-h-screen">
        ...
        >
          Join us in the heart of the Philippines for an unforgettable conference experience
        </motion.p>
        <motion.div
        ...
        >
          <div className="bg-green-100 bg-opacity-50 p-6 rounded-lg backdrop-blur-md border border-green-400/30">
            <h3 className="text-2xl font-semibold mb-2 text-green-900">World-Class Venue</h3>
            <p className="text-green-100">State-of-the-art facilities in the heart of Manila</p>
          </div>
          <div className="bg-green-100 bg-opacity-50 p-6 rounded-lg backdrop-blur-md border border-green-400/30">
            <h3 className="text-2xl font-semibold mb-2 text-green-900">Cultural Hub</h3>
            <p className="text-green-100">Immerse yourself in Filipino hospitality and culture</p>
          </div>
          <div className="bg-green-100 bg-opacity-50 p-6 rounded-lg backdrop-blur-md border border-green-400/30">
            <h3 className="text-2xl font-semibold mb-2 text-green-900">Networking Paradise</h3>
            <p className="text-green-100">Connect with industry leaders in a tropical setting</p>
          </div>
        </motion.div>
        <motion.button
